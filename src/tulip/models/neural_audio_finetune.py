...
through the canonical shared loader. Fine-tuning reuses the plain torch loop
from :mod:`tulip.models.neural_text` (AdamW + linear warmup, optional balanced
class weights). All heavy dependencies (torch, transformers, soundfile) are
